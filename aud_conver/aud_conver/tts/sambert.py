...
class Callback(ResultCallback):
    def __init__(self):
        super().__init__()
        self.len = 0 
        self.timestamp_printed = False  # 标记时间戳是否已打印
...
def text2mp3(text, output_file='output.wav', **synth_kwargs):
    ...
    try:
        ...
        timestamps_pub = rospy.Publisher('/timestamps', String, queue_size=20)
        msg = String()
        msg.data = result.get_timestamps()
        print(msg.data)
        timestamps_pub.publish(msg)
